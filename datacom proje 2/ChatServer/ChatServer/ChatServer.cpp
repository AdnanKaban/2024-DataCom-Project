...
// winsock windows işletim sistemi üzerinde ağ iletişimi (networking) yapmak için kullanılan 
// bir api'dir. TCP/IP protokolü kullanarak iki ciğaz arasında veri göndermemizi sağlar.
// soket, bir bilgisayarın ağ üzerindeki bir cihazla iletişim kurmak için kullandığı uç noktadır. 
// Görüşme için bir numara (IP adresi) ve hat (port) gerekir.
